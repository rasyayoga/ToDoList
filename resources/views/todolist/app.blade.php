            ...
            <div class="col-md-8">
             <div class="card mb-3">
                ...
                @endif
                    ...
                    <!-- 02. Form input data -->
                    <form id="todo-form" action="{{ route('dashboard.post') }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group mb-4" id="todo-list">
                                ...
                                <input type="text" class="form-control edit-input" style="display: none;"
                                    ...
                                    <div class="btn-group gap-2">
                                        <button class="btn btn-danger btn-sm delete-btn" 
                                            data-id="{{ $item->id }}" 
                                            data-url="{{ route('dashboard.delete', ['id' => $item->id]) }}"
                            ...
                            <li class="list-group-item collapse" id="collapse-{{ $loop->index }}">
                                <form action="{{ route('dashboard.update', ['id' => $item->id]) }}" method="POST">
                                    @csrf
                                    @method('put')
                                    <div>
